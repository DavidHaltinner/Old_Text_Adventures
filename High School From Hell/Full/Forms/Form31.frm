...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a hallway.  There is an exit to the foyer to the north, and an exit to the main hall south, and stairs going up."
        Case "u", "up"
            level = 2
            Form48.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a hallway.  There is an exit to the foyer to the north, and an exit to the main hall south, and stairs going up."
Form31.Caption = "High School From Hell"
