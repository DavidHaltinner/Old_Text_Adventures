...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a hall.  There is a hall north and south.  There is a room west and stairs going down."
        Case "d", "down"
            level = 2
            Form38.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a hall.  There is a hall north and south.  There is a room west and stairs going down."
Form49.Caption = "High School From Hell"
