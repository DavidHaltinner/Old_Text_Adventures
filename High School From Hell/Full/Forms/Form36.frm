...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in the main hallway.  There are locked doors north and south but there are halls east and west."
        
        Case "n", "north", "s", "south"
            Label2.Caption = "They are locked"
        Case "e", "east"
            level = 2
            Form37.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in the main hallway.  There are locked doors north and south but there are halls east and west."
Form36.Caption = "High School From Hell"
