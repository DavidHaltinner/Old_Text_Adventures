...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are standing in the auditorium.  There are many rows of seats and you can see a balcony above you.  You can go onstage to the north or go south."
        Case "s", "south"
            level = 2
            Form16.Show
            Unload Me
...
level = 1
Label2.Caption = "You are standing in the auditorium.  There are many rows of seats and you can see a balcony above you.  You can go onstage to the north or go south."
Form15.Caption = "High School From Hell"
