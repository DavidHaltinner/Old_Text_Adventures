...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a part of the main hallway.  There is a hall to the north, and the library is south and there are stairs going up."
        Case "u", "up"
            level = 2
            Form42.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a part of the main hallway.  There is a hall to the north, and the library is south and there are stairs going up."
Form33.Caption = "High School From Hell"
