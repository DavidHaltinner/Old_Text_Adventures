...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a hallway with another hall to the north and one to the south.  There are also some stairs going up."
        Case "u", "up"
            level = 2
            Form45.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a hallway with another hall to the north and one to the south.  There are also some stairs going up."
Form6.Caption = "High School From Hell"
