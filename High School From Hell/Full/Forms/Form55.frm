...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are on the balcony for the auditorium.  The only exit is down."
        Case "d", "down"
            level = 2
            Form16.Show
            Unload Me
        Case "look at auditorium", "examine auditorium"
            Label2.Caption = "It's down there"
...
level = 1
Label2.Caption = "You are on the balcony for the auditorium.  The only exit is down."
Form55.Caption = "High School From Hell"
