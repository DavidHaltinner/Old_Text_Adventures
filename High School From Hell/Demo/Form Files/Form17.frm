...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a section of the foyer.  Another section is to the West and to the East.  To the north are the commons."
        Case "w", "west"
            level = 2
            Form16.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a section of the foyer.  Another section is to the West and to the East.  To the north are the commons."
Form17.Caption = "High School From Hell"
