...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a section of the foyer.  More sections lie to the West and East.  A hall lies to the north, and another to the south."
        Case "w", "west"
            level = 2
            Form11.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a section of the foyer.  More sections lie to the West and East.  A hall lies to the north, and another to the south."
Form10.Caption = "High School From Hell"
