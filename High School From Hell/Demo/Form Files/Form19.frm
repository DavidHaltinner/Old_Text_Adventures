...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a section of the foyer.  There is a section to the east and west of you.  There is a hall to the south."
        Case "s", "south"
            level = 2
            Form31.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a section of the foyer.  There is a section to the east and west of you.  There is a hall to the south."
Form19.Caption = "High School From Hell"
