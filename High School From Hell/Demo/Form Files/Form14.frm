...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are standing on the stage of the auditorium.  There is an exit to the west and you can get of the stage to the south."
        Case "s", "south"
            level = 2
            Form15.Show
            Unload Me
...
level = 1
Label2.Caption = "You are standing on the stage of the auditorium.  There is an exit to the west and you can get of the stage to the south."
Form14.Caption = "High School From Hell"
