...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a hallway.  The gym is to the east, and to the north is another hall, there are stairs going up, and an exit to the south-east."
        Case "n", "north"
            level = 2
            Form26.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in a hallway.  The gym is to the east, and to the north is another hall, there are stairs going up, and an exit to the south-east."
Form25.Caption = "High School From Hell"
