...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in the gym.  There are basketball hoops and a locked supply room to the north.  There are exits East, south and West."
        Case "w", "west"
            level = 2
            Form25.Show
            Unload Me
...
level = 1
Label2.Caption = "You are in the gym.  There are basketball hoops and a locked supply room to the north.  There are exits East, south and West."
Form24.Caption = "High School From Hell"
