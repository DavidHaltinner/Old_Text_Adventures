...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "You are in a hallway with another hall to the north and one to the south.  There is also a room to the west."
...
level = 1
Label2.Caption = "You are in a hallway with another hall to the north and one to the south.  There is also a room to the west."
Form7.Caption = "High School From Hell"
