...
Private Sub level1()
        ...
        Case "look", "l"
            Label2.Caption = "There is an elevator behind you.  Behind you by the elevator is a button with an arrow on it.  Halls go off to the North and west."
        Case "e", "east"
            level = 2
            Form25.Show
            Unload Me
