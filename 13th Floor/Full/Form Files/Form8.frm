...
Private Sub level1()
        ...
        Case "look at painting", "examine painting"
            Label2.Caption = "Its a painting of President Lincoln"
        Case "look at coffee table", "look at table", "look at coffeetable"
            Label2.Caption = "Its a 4 legged table without any doors on the cupboard, its empty."
        Case "west", "w"
            level = 2
            Form9.Show
            Unload Me
