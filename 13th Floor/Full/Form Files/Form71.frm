...
Private Sub level1()
        ...
        Case "west", "w"
            ...
            Form70.Show
            Unload Me
        Case "look at rats", "look at dead rats", "examine rats"
            Label2.Caption = "There are 100s of them piled up on the floor all dead and rotting."
        Case "s", "south"
            level = 2
            Form72.Show
            Unload Me
