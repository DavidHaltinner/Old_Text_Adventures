...
Private Sub level1()
        ...
        Case "break open lock", "break open chest", "hit chest", "hit lock", "hit lock with hammer", "hit chest with hammer"
            Label2.Caption = "You swing the hammer at the chest and break the lock.  The chest swings open and in side it is a key."
        ...
        Case "look at key", "examine key"
            Label2.Caption = "It is a small normal key."
        Case "take key", "pick up key"
            level = 2
            Form12.Show
            Unload Me
        Case Else
