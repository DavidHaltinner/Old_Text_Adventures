...
Private Sub level1()
        ...
        Case "look at coffee table", "look at table"
            Label2.Caption = "It has 4 legs and the cupboard in it has lost its doors and it is empty."
        Case "look at painting", "examine painting"
            Label2.Caption = "It's a painting of President Lincoln."
        Case "west", "w"
            level = 2
            Form68.Show
            Unload Me
